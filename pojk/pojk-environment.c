 ...
 */
void
pojk_set_environment (const gchar *env)
{
 ...
 *
 * For @fallback_env you can use for example #POJK_ENVIRONMENT_XFCE.
 *
 * Since: 0.3.0
 */
void
pojk_set_environment_xdg (const gchar *fallback_env)
{
  const gchar *desktop;
