 ...
 * @short_description: Information about the pojk version in use.
 * @include: pojk/pojk.h
 *
 * The pojk library provides version information, which could be used
 ...
 * pojk_major_version:
 *
 * The major version number of the pojk library (e.g. in
 * version 4.8.0 this is 4).
 *
 * This variable is in the library, so represents the
 * pojk library you have linked against. Contrast with the
 * #POJK_MAJOR_VERSION macro, which represents the major
 * version of the pojk headers you have included.
 **/
const guint pojk_major_version = POJK_MAJOR_VERSION;

/**
 * pojk_minor_version:
 *
 * The minor version number of the pojk library (e.g. in
 * version 4.8.0 this is 8).
 *
 * This variable is in the library, so represents the
 * pojk library you have linked against. Contrast with the
 * #POJK_MINOR_VERSION macro, which represents the minor
 * version of the pojk headers you have included.
 **/
const guint pojk_minor_version = POJK_MINOR_VERSION;

/**
 * pojk_micro_version:
 *
 * The micro version number of the pojk library (e.g. in
 * version 4.8.0 this is 0).
 *
 * This variable is in the library, so represents the
 * pojk library you have linked against. Contrast with the
 * #POJK_MICRO_VERSION macro, which represents the micro
 * version of the pojk headers you have included.
 **/
const guint pojk_micro_version = POJK_MICRO_VERSION;
 ...
 *
 * Checks that the <systemitem class="library">pojk</systemitem>
 * library in use is compatible with the given version. Generally you
 * would pass in the constants #POJK_MAJOR_VERSION,
 * #POJK_MINOR_VERSION and #POJK_MICRO_VERSION as the three
 * arguments to this function; that produces a check that the library
 * in use is compatible with the version of
 * <systemitem class="library">pojk</systemitem> the application was
 * compiled against.
 *
 * <example>
 * <title>Checking the runtime version of the pojk library</title>
 * <programlisting>
 * const gchar *mismatch;
 * mismatch = pojk_check_version (POJK_VERSION_MAJOR,
 *                                  POJK_VERSION_MINOR,
 *                                  POJK_VERSION_MICRO);
 ...
 **/
const gchar*
pojk_check_version (guint required_major,
...
gchar **
pojk_config_build_paths (const gchar *filename)
{
 ...
 **/
gchar *
pojk_config_lookup (const gchar *filename)
{
  const gchar * const *dirs;
  gchar               *path;
  guint                i;
  ...
  /* Also try the install prefix of pojk in case XDG_CONFIG_DIRS is not
